    ...
    sections: [
      {
        ...
        items: [
          ...
          { label: 'Users', href: '/portal/admin/users', icon: UsersRound },
          { label: 'Roles', href: '/portal/admin/roles', icon: Shield },
          { label: 'Permissions', href: '/portal/admin/permissions', icon: Key },
        ],
      },
      {
        label: 'Configuration',
        items: [
          { label: 'Institution Settings', href: '/portal/admin/settings', icon: Settings2 },
          { label: 'LMS Configuration', href: '/portal/admin/lms', icon: BookOpen },
          { label: 'CBT Configuration', href: '/portal/admin/cbt', icon: ClipboardCheck },
          { label: 'Accreditation', href: '/portal/admin/accreditation', icon: BadgeCheck },
        ],
      },
      {
        label: 'Monitoring',
        items: [
          { label: 'Database', href: '/portal/admin/database', icon: Database },
          { label: 'Security', href: '/portal/admin/security', icon: Shield },
          { label: 'Audit Logs', href: '/portal/admin/audit', icon: History },
          { label: 'API Management', href: '/portal/admin/api', icon: Webhook },
        ],
      },
      {
        label: 'Account',
        items: [
          { label: 'Profile', href: '/portal/admin/profile', icon: Users },
          { label: 'Notifications', href: '/portal/admin/notifications', icon: BellRing },
        ],
      },
    ],
  },
