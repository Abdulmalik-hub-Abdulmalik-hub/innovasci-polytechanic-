...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  ...
  director_cbt_services: [
    ...
    'cbt.exams.view', 'cbt.exams.create', 'cbt.exams.edit', 'cbt.exams.publish', 'cbt.exams.approve',
  ...
  admission_officer: [
    'dashboard.view', 'dashboard.analytics',
    'admission.view', 'admission.create', 'admission.edit', 'admission.approve', 'admission.reject', 'admission.review', 'admission.verify',
    'documents.view', 'documents.download', 'documents.verify',
    'reports.view', 'reports.create', 'reports.export',
    'notifications.view', 'notifications.send',
  ],
  ...
  // Additional academic portal roles
  hod: [
    'dashboard.view', 'dashboard.analytics',
    'students.view',
    'academic.view', 'academic.edit', 'academic.approve',
